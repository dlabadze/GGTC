...
class SeptemberRequest(models.Model):
    ...
    #             'params': {
    #                 'title': _("No New Lines"),
    #                 'message': _("All September lines have already been included in this budget request."),
    #                 'type': 'warning',
    #                 'sticky': False,
    #             }
    #         }
    ...
    #
    #         dep_type = getattr(line, 'x_studio_related_field_5ot_1j2hik7te', None)
    ...
    #                 vals[dep_field] += getattr(existing, dep_field)
    #             existing.write(vals)
    #             updated_lines += 1
    #         else:
    ...
    #         'tag': 'display_notification',
    #         'params': {
    #             'title': _("Budgeting Lines Updated Successfully"),
    #             'message': message,
    #             'type': 'success',
    #             'sticky': False,
    #         }
