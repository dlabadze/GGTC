...
class FetchWaybillswizard1(models.TransientModel):
    ...
    def fetch_waybills_1(self):
        try:
            ...
            response_data = body.get('get_buyer_waybillsResponse', {}) if isinstance(body, dict) else {}
            result_data = response_data.get('get_buyer_waybillsResult', {}) if isinstance(response_data, dict) else {}
            ...
            for waybill_data in waybills:
                ...
                waybill_number = str(waybill_number_raw or '')
                    ...
                    for item in goods_list:
                        ...
                        if product_buyer_info:
                            ...
                            waybill_line_vals.append({
                                ...
                                **item,
                                'product_id': product_buyer_info.product_id.id,
