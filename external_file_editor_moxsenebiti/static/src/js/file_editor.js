...
/**
 * External File Editor Client Action for Moxsenebiti
 * Sends file to external editor silently without displaying any UI
 */
async function externalFileEditorMoxsenebitiAction(env, action) {
    ...
    try {
        ...
        console.log("Sending moxsenebiti file to external editor:", externalEditorUrl);
        console.log("Payload:", {
...
registry.category("actions").add("external_file_editor_moxsenebiti", externalFileEditorMoxsenebitiAction);
